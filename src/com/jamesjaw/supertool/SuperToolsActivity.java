...
import com.jamesjaw.supertool.receiver.SMSObserver;
...
public class SuperToolsActivity extends FragmentActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_super_tools, menu);
		return true;
	}
	...
	public static class DummySectionFragment extends Fragment {
	 ...
	 public void addSMSObserver()

	    {
	       ...
	       Debug.show("add a SMS observer. ");
  
	       Handler handler = new Handler();

	       ContentResolver resolver = getContentResolver();
	       
	       SMSObserver mObserver = new SMSObserver(handler, getApplicationContext());
